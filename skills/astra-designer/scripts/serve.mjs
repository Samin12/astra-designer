#!/usr/bin/env node
/**
 * astra-designer static server.
 *
 * A astra-designer page cannot be verified from file://. The engine fetches each
 ...
 * Serve it.
 *
 *   node serve.mjs --root builds/example --port 4500
 */
...
http.createServer((req, res) => {
  ...
  console.log(`astra-designer: ${ROOT}\n  http://localhost:${PORT}`);
});
