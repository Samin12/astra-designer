...
Changing imagery and color while repeating the same hero, navigation, act sequence and closing CTA produces a template. Choose structure deliberately before choosing devices.
...
which makes it an easy default to overuse.
